...
public class LandAttendantController_Edit {
	
	LandAttendant chosen = (LandAttendant) PanelEmployeesController.chosenEmployee;
	...
	public void editLandAttendant (ActionEvent event) {
	   ...
	   if(invalidLabels.isEmpty()) {
		   LandAttendantLogic.getInstance().editLandAttendant(inputID, inputfname, inputlname, inputJoinDate, inputEndDate);
