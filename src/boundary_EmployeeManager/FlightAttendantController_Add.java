...
public class FlightAttendantController_Add {
	...
	public void addNewFlightAttendant (ActionEvent event) {
	   ...
	   if(invalidLabels.isEmpty()) {
		   FlightAttendant newFlightAttendant= new FlightAttendant(inputID, inputfname, inputlname, inputJoinDate, inputEndDate);
		   System.out.println(newFlightAttendant);
		   FlightAttendantLogic.getInstance().addFlightAttendant(newFlightAttendant);
