...
public class FlightController_Add {
	...
	// invalids:
	 ...
	 @FXML private Label invalidFlightExist;
	...
	/*----------------------------------------------------------------------------------------------------------*/
	 ...
	 public void initialize() {
		 ...
		 flightID.setTextFormatter(new TextFormatter<String>(TextFormats.getInstance().onlyNumbers()));
	...
	@FXML
		 ...
		 for(Label l: invalidLabels) {
		   ...
		   if(inputID == null || inputID.isEmpty()) 
			   invalidLabels.add(invalidID);
	 	       ...
	 	       invalidLabels.add(invalidID);
		   else if( FlightLogic.getInstance().checkID(new Flight(inputID)))
			   invalidLabels.add(invalidFlightExist); // if flight id is already Exists
	       ...
	       if(!invalidLabels.isEmpty()) { // if there are invalid fields
	    	   for(Label l: invalidLabels) {
	        	   ...
	        	   if(l.equals(invalidFlightExist))
	        		   l.setText("This flight number is already exist");
	           }
	       } else {/*----------------------------Creates new Flight to add to DB--------------------------------------------*/ 
	    	   
	    	   Flight newFlight = new Flight(inputID, inputDepDateTime, inputArvDateTime, 
	    			   inputDepAirport, inputArvAirport, inputPlane);
	    	   
	    	   String s = FlightLogic.getInstance().addFlight(newFlight);
	    	   ...
	    	   } else if(s.equals("Flight is already exsist")) {
	 ...
	 /*----------------------------------------------------------------------------------------------------------*/
	    ...
	    public void openAddPlane (ActionEvent event) {
	    	...
	    	Main.openPopScreen(PlanePopStage, "/boundary_FlightManager/Plane_Add.fxml");
	    ...
	    public <CloseEvent> void closeAddPlane() {
		    ...
		    public void openAddAirport (ActionEvent event) {
		    	...
		    	Main.openPopScreen(AirportPopStage, "/boundary_FlightManager/Airport_Add.fxml");
